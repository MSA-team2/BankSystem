...
public class TransactionController {
		...
		List<String> types = Arrays.asList("100");
		 ...
		 accountNo = getInput("계좌번호 : ");
		 	...
		 	if(!Validator.isValidHyphenAccountNumber(accountNo)) {
		 		System.out.println("올바른 계좌번호 형식이 아닙니다."); return;
		 	}
	...
	public void withdraw() throws SQLException {
		...
		String accountNo;
		 ...
		 ts.withdraw(dto);
		 for (AccountShowDTO showdto : list) {
			 if (dto.getAccountNo().equals(accountNo)) {
			        System.out.println("출금되었습니다. 남은 잔액 : " + showdto.getBalance());
			        break;
			  }
		 }
	 }
	...
	public void transfer() throws SQLException {
		...
		while (true) {
		 ...
		 ts.deposit(d_dto);
		 for (AccountShowDTO showdto : list) {
			 if (w_dto.getAccountNo().equals(w_accountNo)) {
			        System.out.println("출금되었습니다. 남은 잔액 : " + showdto.getBalance());
			        break;
			  }
		 }
